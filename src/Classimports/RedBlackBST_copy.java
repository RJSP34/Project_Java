...
public class RedBlackBST_copy<Key extends Comparable<Key>, Value>implements Serializable {
    ...
    public    int howmanyreds(Node rd) {
if(rd.right==null && rd.left==null && isRed(rd)){
   return 1;
        ...
        if(rd.right==null && isRed(rd)){

            return howmanyreds(rd.left)+1;

        }
        if(rd.right==null && !isRed(rd)){

            return howmanyreds(rd.left);

        }
        if(rd.right!=null && isRed(rd)){

            return howmanyreds(rd.right)+1;

        }
        if(rd.right!=null && !isRed(rd)){

            return howmanyreds(rd.right);

        }
        if(isRed(rd)){
            return howmanyreds(rd.right)+howmanyreds(rd.left)+1;

        }else {
            return howmanyreds(rd.right)+howmanyreds(rd.left);
        }
